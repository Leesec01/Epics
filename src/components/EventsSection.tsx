...
const technicalEvents = [
  ...
  {
    title: 'Bug Fixers',
    description: 'Debug, analyze, and solve coding errors within a limited time. Showcase your logical thinking and problem-solving skills in this thrilling challenge.',
    coordinator: 'Mr. Karthik S',
    icon: Brain,
    registerUrl: '',
  },
];
...
const nonTechnicalEvents = [
  ...
  },
  {
    ...
    description: 'A grand stage to express your hidden talents. Singing, dancing, mimicry, stand-up comedy, or any unique skill – the spotlight is yours!',
    coordinator: 'Ms. Nivetha P',
    icon: Film,
    registerUrl: '',
  },
];
